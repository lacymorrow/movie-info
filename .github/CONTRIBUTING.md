...
Thanks for considering a contribution! `movie-info` is small, stable, and gets the occasional bug-fix release.

## Setup

```bash
git clone https://github.com/lacymorrow/movie-info.git
cd movie-info
npm install
```
